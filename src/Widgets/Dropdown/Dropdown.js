  ...
  return (
    <div className="dropdown-wrapper" ref={dropdownRef}>
      ...
      >
        ...
        <span className="dropdown-arrow">{downarrow}</span>
      </button>
      {isOpen && (
        <ul className="dropdown-list">
          <li className="dropdown_search_list">
            <div className="dropdown_search_icon">
              {dropdownsearchicon}
            </div>
            <input
            placeholder="Search"
             className="dropdown_search_box"
            />

          </li>
          {filteredResults.length > 0 ? (
            filteredResults.map((result) => (
              <li className="dropdown_result_list" key={result}>
                <span
            ...
            <li>
              <span className="dropdown-no-results">
                No results found
              </span>
            </li>
          )}
